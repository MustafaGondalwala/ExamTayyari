          ...
          <div class="col-md-12">
            <div class="card my-3">
              ...
              @if (count($errors) > 0)
                ...
                @endif
                <form method="POST" enctype="multipart/form-data" action="{{route('admin.ebook.addPost')}}">
                    @csrf
                  ...
                  <div class="mb-3 input-group-decoration">
                    ...
                    <div class="input-group mb-3">
                    <textarea name="description" class="form-control">@isset($form_data['description']) {{$form_data['description']}}  @endisset</textarea>
                    </div>
                    ...
                    @isset($form_data) 
                    <a href="{{$form_data['link'] ? $form_data['link'] : ''}}">Download</a>
                     @endisset
                    <div class="input-group mb-3">
                      <input
                        type="text"
                        ...
                        class="form-control input"
                        id="link"
                        value="@isset($form_data) {{$form_data['link'] ? $form_data['link'] : ''}} @endisset"
                        name="link"
                      />
                    </div>
